...
**MolPredictor** leverages **GINEConv** and **Evidential Deep Learning** for reliable molecular property prediction. We focus on solving Out-of-Distribution (OOD) challenges and enhancing model interpretability for drug discovery.

**MolPredictor** 致力于通过 **GINEConv** 与 **证据深度学习** 实现可靠的分子性质预测。我们专注于解决药物研发中的分布外（OOD）挑战，并提升模型决策的可解释性。
...
## 📜 Academic Goals / 学术目标
This project is part of a long-term research plan for **AI for Science (AI4S)**. We aim to contribute high-quality, reproducible code to the community and secure full-funded PhD opportunities in top-tier institutions 

本项目是 **AI for Science (AI4S)** 长期研究计划的一部分。我们旨在为社区贡献高质量、可复现的开源代码，并以此支撑冲击全球顶尖院校的直博申请。

---
## Contact:
    * ** English Name ** * [Vincent Arthur Leung]  
    * ** Chinese name ** * [梁振雄]
    * ** Academic ** * [20251008460@stu.shzu.edu.cn]
    * ** Personal ** * [vincentarthurleung@gmail.com]
    * ** Github ** * [https://github.com/vincentarthurleung-rgb]
